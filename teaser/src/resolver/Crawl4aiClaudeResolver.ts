...
const SYSTEM_PROMPT = `You analyze a company's own website to build a structured profile for a competitive-visibility audit.

You will receive labeled markdown for one or more pages of a single company's site (homepage, and possibly a pricing/comparison page).
...
Base everything ONLY on the provided page content. Do not invent competitors or claims you cannot support from the markdown.`;
